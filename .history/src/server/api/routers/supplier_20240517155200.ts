...
export const supplierRouter = createTRPCRouter({
  ...
  createSupplierAndContacts: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      if (!session.user) {
        throw new TRPCError({
          code: "UNAUTHORIZED",
          message: "You must be logged in to add a supplier"
        });
      }
      ...
      const adminDictionary = {
        ggarcia: 'Von Garcia',
        aarcila: 'Alex Arcila',
        pogarcia: 'Polo Garcia',
        jalbright: 'Jordan Albright',
      }
      ...
      if (user === 'ggarcia') {
        updatedBy = adminDictionary.ggarcia;
      } else if (user === 'aarcila') {
        updatedBy = adminDictionary.aarcila;
      } else if (user === 'pogarcia') {
        updatedBy = adminDictionary.pogarcia;
      } else if (user === 'jalbright') {
        updatedBy = adminDictionary.jalbright;
      } else {
        updatedBy = null;
      }
  ...
  editSupplierAndContacts: protectedProcedure
    .input(z.object({
      ...
      repressentativeName: z.string().nullable(),
      representativeCompanyName: z.string().nullable(),
      representativeCompanyTitle: z.string().nullable(),
      representativeCompanyPhone: z.string().nullable(),
      representativeCompanyEmail: z.string().nullable(),
