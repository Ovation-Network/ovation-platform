  ...
  createSupplierAndContacts: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const adminDictionary = {
        'ggarcia@theovationnetwork.com': 'Von Garcia',
        'aarcila@theovationnetwork.com': 'Alex Arcila',
        'pogarcia@theovationnetwork.com': 'Polo Garcia',
        'jalbright@theovationnetwork.com': 'Jordan Albright',
      }

      const updatedBy = adminDictionary[`${session.user.email}` as string] || null;
