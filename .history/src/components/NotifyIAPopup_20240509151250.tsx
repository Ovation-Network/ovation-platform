        ...
        <div className="modal-box bg-white">
          <form id="notifyIAForm" method="dialog bg-white">
            ...
            <div className="sm:col-span-2">
              <label htmlFor="details" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black pt-2">What did you notice we need to change regarding {name}?</label>
