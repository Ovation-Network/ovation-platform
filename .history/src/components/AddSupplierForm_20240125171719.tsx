        ...
        <div className="flex justify-center">
          <div className="form-control w-full max-w-xs">
            ...
            <div className="btn-group my-5">
              <div className={onsiteContact ? 'btn btn-active' : 'btn'} value="onsite" onClick={() => setOnsiteContact((prevValue) => !prevValue)}>ONSITE</div>
              <div className={representativeCompany ? 'btn btn-active' : 'btn'} value="rep" onClick={() => setRepresentativeCompany((prevValue) => !prevValue)}>REP COMPANY</div>
              <div className={generalManager ? 'btn btn-active' : 'btn'} value="manager" onClick={() => setGeneralManager((prevValue) => !prevValue)}>GEN MANAGER</div>
            </div>
          </div>
        </div>
