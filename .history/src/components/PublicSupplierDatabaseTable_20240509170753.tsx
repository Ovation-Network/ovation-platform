...
export const PublicSupplierDatabaseTable: React.FC = () => {
  ...
  return (
      ...
      {/* PAGINATION */}
        <div className="flex justify-center mr-2 self-center">
          <div className="flex flex-row">
            ...
            <button className="btn bg-[#2dd4bf] btn-sm text-white border-b-secondary" onClick={nextPage}>Next</button>
          </div>
        </div>
    ...
    {/* 
    <div class="overflow-x-auto mx-auto my-2 rounded-lg">
    {#if table.length}
      <table class="table-fixed px-2">
    */}
