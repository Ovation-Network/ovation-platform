    ...
    <div className="p-5">
      ...
      <div>
        <table className="table-fixed">
          <thead>
            <tr>
              <th className="bg-teal-400 text-xl">Region</th> 
              <th className="bg-teal-400 text-xl">Country</th> 
              <th className="bg-teal-400 text-xl">City</th> 
              <th className="bg-teal-400 text-xl">Hotel</th> 
