...
export function InfiniteSupplierScrollContainer({
  suppliers,
  isError,
  isLoading,
  fetchNewSuppliers,
...
function SupplierCollapseItem({
  ...
  return (
    <div tabIndex={id} className="collapse border border-base-300 bg-white text-black mb-3"> 
      <div className="collapse-title text-xl font-medium">
        <div className="flex justify-between">
          <div>
            <h2>{name} - {id}</h2>
            <p>{type} - {country} - {region} - {state}</p>
          </div>
