...
const PublicEnhancedCommissionsTable: React.FC<PublicEnhancedCommissionProps[]> = (props) => {
  ...
  useEffect(() => {
    ...
    search !== '' && setEnhancedCommissionData((currentData) => filter === 'supplier' ? filterEnhancedCommissionsDataByName(currentData, search) : filterEnhancedCommissionsDataByLocation(currentData, search));
