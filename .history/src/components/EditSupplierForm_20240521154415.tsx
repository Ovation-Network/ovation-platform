      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-center">
          <div className="form-control w-full max-w-xs">
            ...
            <div className="join">
              <button className={onsiteContact ? 'btn bg-white join-item md:btn-sm btn-active' : 'btn join-item md:btn-sm'} onClick={() => setOnsiteContact((prevValue) => !prevValue)} type='button'>ONSITE</button>
              <button className={representativeCompany ? 'btn join-item md:btn-sm btn-active' : 'btn join-item md:btn-sm'} onClick={() => setRepresentativeCompany((prevValue) => !prevValue)} type='button'>REP COMPANY</button>
              <button className={generalManager ? 'btn join-item md:btn-sm btn-active' : 'btn join-item md:btn-sm'} onClick={() => setGeneralManager((prevValue) => !prevValue)} type='button'>GEN MANAGER</button>
            </div>
          </div>
        </div>
