...
const NotifyIAPopup: React.FC<NotificationProps> = ({ supplierId, supplierName }) => {
  ...
  }, [supplierName, supplierId, id, notificationAPI, modal])
        ...
        <div className="modal-box bg-white">
          <form id="notifyIAForm" method="dialog bg-white" onSubmit={notifyIA}>
            <div>
              ...
              <input tabIndex={0} name="name" type="text" id="name" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-300 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Enter name here" required/>
            </div>
            <div className="sm:col-span-2">
              ...
              <textarea tabIndex={0} name="details" id="details" rows={6} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-300 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter details here...." required></textarea>
            </div>
