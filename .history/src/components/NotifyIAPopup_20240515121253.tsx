...
export const NotifyIAPopup: React.FC<NotificationProps> = ({ supplierId, supplierName, supplierLocation }) => {
  ...
  return (
    ...
    {/* You can open the modal using document.getElementById('ID').showModal() method */}
      <button className="btn bg-[#f8ff3796] btn-sm text-gray-500 border-[#c3d42d] hover:bg-teal-400 hover:border-yellow-300 hover:text-white" onClick={openModal}>FLAG</button>
