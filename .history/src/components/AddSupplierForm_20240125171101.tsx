      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-center">
          <div className="form-control w-full max-w-xs">
            ...
            <select id="option-select" className="select select-bordered w-full max-w-xs" value={supplierType} required>
              <option disabled selected value="">--Choose Suppliery Type--</option>
              {supplierTypeOptions.map((option) => <option value={option}>{option}</option>)}
                                    
            </select>

            <div className="btn-group my-5">
              <button className={onsiteContact ? 'btn btn-active' : 'btn'} value="onsite" onClick={() => setOnsiteContact((prevValue) => !prevValue)}>ONSITE</button>
              <button className={representativeCompany ? 'btn btn-active' : 'btn'} value="rep" onClick={() => setRepresentativeCompany((prevValue) => !prevValue)}>REP COMPANY</button>
              <button className={generalManager ? 'btn btn-active' : 'btn'} value="manager" onClick={() => setGeneralManager((prevValue) => !prevValue)}>GEN MANAGER</button>
            </div>
          </div>
        </div>
        ...
        {/* CODE FOR ONSITE CONTACT */}
          ...
          <div className="flex justify-center">
            <div className="form-control w-full max-w-xs pr-2">
              ...
              <input value={representativeTitle} type="text" placeholder="Type here" className="input input-bordered w-full max-w-xs" onChange={(e) => setRepresentativeTitle}/>
            </div>
            ...
            <div className="form-control w-full max-w-xs pr-2">
              ...
              <input value={representativePhone} type="text" placeholder="Type here" className="input input-bordered w-full max-w-xs" onChange={(e) => setRepresentativePhone}/>
            </div>
          </div>
          <div className="flex justify-center">
            <div className="form-control w-full max-w-xs pr-2">
