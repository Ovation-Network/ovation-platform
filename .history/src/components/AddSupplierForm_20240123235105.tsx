    ...
    <>
        ...
        <div class="flex justify-center">
          <div class="form-control w-full max-w-xs pr-2">
            ...
            <input value={supplier_name} type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs" required/>
          </div>
          ...
          <div class="form-control w-full max-w-xs">
            ...
            <input value={supplier_country} type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs" required/>
          </div>
        </div>
        <div class="flex justify-center">
          <div class="form-control w-full max-w-xs pr-2">
            ...
            <input value={supplier_city} type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs" required/>
          </div>
          <div class="form-control w-full max-w-xs">
            <label class="label">
              <span class="label-text">STATE</span>
            </label>
            <input value={supplier_state} type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs" />
          </div>
        </div>
        <div class="flex justify-center">
          <div class="form-control w-full max-w-xs">
            ...
            <select id="option-select" class="select select-bordered w-full max-w-xs" value={supplier_type} required>
        ...
        // CODE FOR ONSITE CONTACT
          ...
          <div class="flex justify-center">
            <div class="form-control w-full max-w-xs pr-2">
              ...
              <input value={onsite_contact_name} type="text" placeholder="Last, First" class="input input-bordered w-full max-w-xs" required/>
            </div>
            ...
            <div class="form-control w-full max-w-xs">
              ...
              <input value={onsite_contact_title} type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs"/>
            </div>
          </div>
          <div class="flex justify-center">
            <div class="form-control w-full max-w-xs pr-2">
              ...
              <input value={onsite_contact_phone} type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs" />
            </div>
            ...
            <div class="form-control w-full max-w-xs">
              ...
              <input value={onsite_contact_email} type="email" placeholder="contact@example.com" class="input input-bordered w-full max-w-xs" required/>
            </div>
          </div>
          ...
          <div class="flex justify-center">
            <div class="form-control w-full max-w-xs pr-2">
              ...
              <input value={representative_company_name} type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs" required/>
            </div>
            ...
            <div class="form-control w-full max-w-xs pr-2">
              ...
              <input value={representative_name} type="text" placeholder="Last, First" class="input input-bordered w-full max-w-xs" required/>
            </div>
          </div>
          <div class="flex justify-center">
            <div class="form-control w-full max-w-xs pr-2">
              ...
              <input value={representative_title} type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs"/>
            </div>
            ...
            <div class="form-control w-full max-w-xs pr-2">
              ...
              <input value={representative_phone} type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs" />
            </div>
          </div>
          <div class="flex justify-center">
            <div class="form-control w-full max-w-xs pr-2">
              ...
              <input value={representative_email} type="email" placeholder="contact@example.com" class="input input-bordered w-full max-w-xs" required/>
            </div>
          </div>
          ...
          <div class="flex justify-center">
            ...
            <div class="form-control w-full max-w-xs pr-2">
              ...
              <input value={general_manager_name} type="text" placeholder="Last, First" class="input input-bordered w-full max-w-xs" />
            </div>
            ...
            <div class="form-control w-full max-w-xs pr-2">
              ...
              <input value={general_manager_title} type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs"/>
            </div>
          </div>
          <div class="flex justify-center">
            <div class="form-control w-full max-w-xs pr-2">
              ...
              <input value={general_manager_phone} type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs" />
            </div>
            ...
            <div class="form-control w-full max-w-xs pr-2">
              ...
              <input value={general_manager_email} type="email" placeholder="contact@example.com" class="input input-bordered w-full max-w-xs" />
            </div>
          </div>

        <div class="flex">
          <button class="btn btn-wide my-5 mx-auto " type="submit">
          </button>
        </div>
      </form>
