  ...
  return (
    ...
    {/* TABLE CONTAINING DATA */}
      ...
      <table className="table-fixed w-full min-h-full">
        ...
        <tbody>
          {isLoading && <tr><div className="flex w-screen h-60 m-auto justify-center align-middle items-center text-black font-semibold text-lg">LOADING....</div></tr>}
          {suppliers?.length === 0 &&  <tr><div className="flex w-screen h-60 m-auto justify-center align-middle items-center text-black font-semibold text-lg">No results found....</div></tr>}
          {suppliers?.map((row, i) => (
