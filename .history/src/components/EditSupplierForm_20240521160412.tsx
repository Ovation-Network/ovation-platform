      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-center">
          <div className="form-control w-full max-w-xs">
            ...
            <select id="option-select" className="select select-bordered bg-white w-full max-w-xs" defaultValue={""} onChange={(e) => setSupplierType(e.target.value as SupplierType)} required>
