        ...
        <div className="modal-box bg-white">
          <form method="dialog bg-white" onSubmit={notifyIA}>
            ...
            <div className="sm:col-span-2">
              ...
              <textarea name="details" id="details" rows={6} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-300 dark:border-gray-300 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Let us know what changes to make....."></textarea>
            </div>
