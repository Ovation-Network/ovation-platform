    ...
    {/* TABLE CONTAINING DATA */}
      ...
      <table className="table-fixed w-full min-h-full">
        ...
        <tbody>
          ...
          {loading && <div className="flex w-screen h-60 m-auto justify-center align-middle items-center text-black font-semibold text-lg">LOADING....</div>}
          {filteredSuppliers?.length === 0 && loading === false &&  <div className="flex w-screen h-60 m-auto justify-center align-middle items-center text-black font-semibold text-lg">No results found....</div>}
