    ...
    {/* TABLE CONTAINING DATA */}
      ...
      <table className="table-fixed w-full min-h-full">
        ...
        <tbody>
          ...
          {filteredSuppliers?.length === 0 && <tr className="mx-auto align-middle text-justify"><div className="h-60 text-center self-center align-middle mx-auto"><p>No results found</p></div></tr>}
