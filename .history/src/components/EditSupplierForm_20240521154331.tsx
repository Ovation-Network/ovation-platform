      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-center">
          <div className="form-control w-full max-w-xs">
            ...
            <div className="join">
              <button className={onsiteContact ? 'btn join-item md:btn-sm btn-active' : 'btn join-item md:btn-sm'} onClick={() => setOnsiteContact((prevValue) => !prevValue)} type='button'>ONSITE</button>
