...
const NotifyIAPopup: React.FC<NotificationProps> = ({ supplierId, supplierName }) => {
  ...
  const [id, setId] = useState<number>(supplierId);
        ...
        <div className="modal-box bg-white">
          <form id="notifyIAForm" method="dialog bg-white" onSubmit={notifyIA}>
            ...
            <div className="sm:col-span-2">
              <label htmlFor="details" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black pt-2">What did you notice we need to change regarind {name}?</label>
