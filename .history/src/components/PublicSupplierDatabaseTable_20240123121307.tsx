    ...
    {/* TABLE CONTAINING DATA */}
      ...
      <table className="table-fixed w-full min-h-full">
        ...
        <tbody>
          ...
          {filteredSuppliers?.length === 0 && isLoading === false &&  <div className="flex w-screen h-60 m-auto justify-center align-middle items-center text-black font-semibold text-lg">No results found....</div>}
