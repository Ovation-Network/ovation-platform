...
import { type enhancedCommissionsByCountryAndCity, type enhanceCommissionsCleaned, indexOfNulls } from "~/utils/data-migration-enhancedCommissions";
...
export default function EnhancedHotelCommissions() {
  ...
  const addEnhancedCommission = async (enhancedCommission: typeof enhancedCommissionsByCountryAndCity[0]) => {
    const payload = {
      name: enhancedCommission.supplier_name,
    ...
    addEnhancedCommissionAPI.mutate(payload)
  }
