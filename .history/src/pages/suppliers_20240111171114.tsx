...
export default function Suppliers() {
  ...
  */
  ...
  function generateSupplierTypeENUM(type: string | null) {
    switch (type) {
      case "Hotel" || "Hotel ":
        return "HOTEL" as string
      case "DMC":
        return "DMC" as string
      case "Tour Operator":
        return "TOUR_OPERATOR" as string
      case "Air":
        return "AIR" as string
      case "Cruise":
        return "CRUISE" as string
      case "Representation Company":
        return "REPRESENTATION_COMPANY" as string
      case "Car Rental":
        return "CAR_RENTAL" as string
      case "Insurance":
        return "INSURANCE" as string
      case "Chauffeur Services" || "Chauffered" || "Chauffered ":
        return "CHAUFFEUR_SERVICES" as string
      case "Trains" || "Rails":
        return "RAIL" as string
      case null:
  ...
  async function migrateSuppliers() {
    ...
    suppliers.forEach((supplier) => {
      ...
      const supplierData = {
        ...
        type: generateSupplierTypeENUM(supplier.supplier_type),
        region: null,
